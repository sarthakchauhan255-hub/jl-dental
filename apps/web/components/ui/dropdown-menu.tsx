...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-dropdown min-w-[180px] overflow-hidden rounded-xl border border-border bg-white p-1 shadow-lg",
  ...
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      destructive
        ...
        : "text-foreground focus:bg-primary-50 focus:text-primary-700",
