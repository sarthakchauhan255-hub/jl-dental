...
>(({ className, children, error, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-12 w-full items-center justify-between rounded-lg border bg-white px-4 py-3",
      "text-base text-foreground placeholder:text-charcoal-300",
      "transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-primary-700/10",
      error
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-4 w-4 text-charcoal-400 shrink-0" />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-lg py-2 pl-8 pr-4",
